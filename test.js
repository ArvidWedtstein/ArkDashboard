...
console.time("optimized2");
const getBaseMaterials3 = (firstRecipeOnly = false, ...objects) => {
  let materials = [];
...
console.log(getBaseMaterials3(true, { itemId: 4, amount: 2 }));
console.timeEnd("optimized2");
