      ...
      <div className="container-xl overflow-hidden bg-gradient-to-t from-black via-black/30 to-black/60 text-center">
        <section className="font-montserrat mx-auto mb-12 max-w-screen-xl p-6 space-y-8">
          ...
          <Card variant="gradient" className="flex group">
            ...
            <CardContent className="text-left space-y-6 p-8 dark:text-zinc-300 text-zinc-500 transition-all duration-200">
              ...
              <div className="">
                <button onClick={() => setOpen(!open)} className="inline-flex">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="ml-2 w-4 fill-current transition-colors shrink-0">
