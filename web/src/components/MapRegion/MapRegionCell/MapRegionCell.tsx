import type { FindMapRegionById } from 'types/graphql'

import type { CellSuccessProps, CellFailureProps } from '@redwoodjs/web'

import MapRegion from 'src/components/MapRegion/MapRegion'

export const QUERY = gql`
  query FindMapRegionById($id: BigInt!) {
...
export const Empty = () => <div>MapRegion not found</div>
...
export const Success = ({ mapRegion }: CellSuccessProps<FindMapRegionById>) => {
  return <MapRegion mapRegion={mapRegion} />
}
