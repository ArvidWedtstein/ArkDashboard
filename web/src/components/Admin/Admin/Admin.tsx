            ...
            },
            {
              ...
              render: ({ value }) => (
                <div className="inline-flex gap-x-2">
                  <svg onClick={() => {
                  }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-5 h-5 transition ease-in-out duration-75 hover:stroke-2 hover:text-red-400 hover:rotate-45">
