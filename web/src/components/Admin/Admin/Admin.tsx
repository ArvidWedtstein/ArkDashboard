            ...
            },
            {
              ...
              render: ({ value, row }) => (
                <div className="inline-flex gap-x-2">
                  {/* Bans for one week */}
                  <button disabled={loading} className="" onClick={() => {
                    toast.custom((t) => (
