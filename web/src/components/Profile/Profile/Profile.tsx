...
import { combineBySummingKeys, relativeDate, timeFormatL } from "src/lib/formatters";
    ...
    <article className="rw-segment">
      ...
      <section className="relative -mt-32 py-16">
        <div className="container-fluid px-4">
          <Card variant="elevation" className="!overflow-visible">
            <CardContent>
              <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full px-4 lg:order-1 lg:w-4/12">
                  <div className="flex justify-center py-4 pt-8 lg:pt-4 space-x-4">
              ...
              <div className="my-6 flex w-full flex-col flex-wrap text-center text-gray-800 dark:text-stone-100">
                ...
                <hr className="rw-divider my-3 w-full mx-auto max-w-md fill-white bg-zinc-500 h-px" />
