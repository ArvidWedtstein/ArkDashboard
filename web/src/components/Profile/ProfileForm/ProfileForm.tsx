    ...
    <div className="">
      ...
      <section className="relative -mt-32 py-16">
        <div className="container-fluid mx-auto px-4">
          <div className="relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-white shadow-xl dark:bg-zinc-700">
            <Form<FormProfile> onSubmit={onSubmit} error={props.error}>
              ...
              <div className="my-6 flex w-full flex-col flex-wrap items-center justify-center text-center text-gray-800 dark:text-stone-100">
                <Input
                  label="Full Name"
                  name="full_name"
                  ...
                  InputProps={{
                    startAdornment: (
                      <svg
                        ...
                        stroke="none"
                        fill="currentColor"
                        className="pointer-events-none h-5 w-5 fill-current"
                        viewBox="0 0 512 512"
                      >
                  ...
                  InputProps={{
                    startAdornment: (
                      <svg
                        ...
                        viewBox="0 0 448 512"
                        fill="currentColor"
                        className="pointer-events-none h-5 w-5 text-gray-500 dark:text-gray-400"
                      >
                ...
                <hr role="separator" className="rw-divider mt-3 w-full mx-auto max-w-lg fill-white bg-zinc-500 h-px" />
                {/* <div className="rw-divide w-full px-10" role="separator" /> */}
