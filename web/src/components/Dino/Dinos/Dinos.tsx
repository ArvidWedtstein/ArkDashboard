      ...
      <div className="3xl:grid-cols-6 grid grid-cols-1 gap-3 md:grid-cols-3 xl:grid-cols-4">
        {dinosPage.dinos.map(
          ({ id, name, type, image, description, tamable, temperament }) => (
            ...
            // </Link>
            <div
              className="clash-card barbarian flex h-full flex-1 flex-col overflow-hidden rounded-lg"
              key={id}
            >
              ...
              <div className="clash-card__level clash-card__level--barbarian inline-flex justify-center">
                {type &&
                  type.map((type) => (
                    <img
                      key={`dino-${id}-${type}`}
              ...
              {/* <div className="clash-card__unit-stats clash-card__unit-stats--barbarian clearfix">
                <div className="one-third">
                  ...
                  <div className="stat-value">KILL</div>
                </div>
                <div className="one-third">
                  <div className="stat inline-flex items-center justify-center fill-white">
                    {
                      {
                        amphibious: (
                          <svg
                ...
                <div className="one-third no-border">
                  <div className="stat inline-flex items-center justify-center">
                    {tamable ? (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
