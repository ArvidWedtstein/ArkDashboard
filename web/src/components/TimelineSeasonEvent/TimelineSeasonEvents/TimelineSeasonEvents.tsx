                ...
                {timeGroup.map(
                  ({ id, title, content, tags, created_at, images }, idx) => (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap h-fit space-x-1 mt-1">
                        {tags &&
