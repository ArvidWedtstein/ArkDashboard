...
const ArkCard = ({ title, subtitle, content, ring, button, image }: IArkCard) => {
  return (
    <div className="bg-gray-600 shadow-md  rounded-3xl" style={{ background: `url('${image}')`, backgroundSize: "cover", backgroundPosition: "center" }}>
      <div className="bg-[#121317]  bg-opacity-60 shadow-md  rounded-3xl p-4">
