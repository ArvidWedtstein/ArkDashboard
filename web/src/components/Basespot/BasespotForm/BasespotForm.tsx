  ...
  }, []);
  {
    /* <div className="relative border-b ">
          <input
            ...
            className="border-1 focus:border-success-600 dark:focus:border-success-500 peer block w-full appearance-none rounded-lg border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-white"
            placeholder=" "
          />
          <label
            htmlFor="floating_outlined"
            className="peer-focus:text-success-600 peer-focus:dark:text-success-500 absolute top-2 left-1 z-10 origin-[0] -translate-y-4 scale-75 transform px-2 text-sm text-gray-500 duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 dark:text-gray-400"
          >
            Floating outlined
          </label>
        </div> */
  ...
  return (
    ...
    >
      ...
      <Lookup
        ...
        getOptionImage={({ icon }) =>
          `https://xyhqysuxlcxuodtuwrlf.supabase.co/storage/v1/object/public/arkimages/Map/${icon}`
        }
        options={props?.maps}
        required
        onSelect={(e) => {
