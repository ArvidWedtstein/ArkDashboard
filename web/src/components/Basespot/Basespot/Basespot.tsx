...
const Basespot = ({ basespot }: Props) => {
  ...
  return (
    <>
      ...
      <div className='flex items-center justify-center mb-3 bg-center py-8 w-full' style={{ imageRendering: "-webkit-optimize-contrast", background: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvC4tJUjp6TudN0t7kMxrGll3AQDUOPCncWSSogN5lgA&s')`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
