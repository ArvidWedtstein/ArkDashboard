    ...
    <>
      <div className="relative flex w-full items-center justify-between py-4 px-6">
        <div className="flex flex-grow items-center">
          ...
          <div className="hidden h-10 w-full max-w-md items-center justify-between overflow-hidden rounded-3xl bg-[#ffffff] pr-3 text-[#ffffffcc] shadow-md dark:bg-[#1f2937] dark:shadow-none md:flex">
            <input
              className="h-full flex-1 border-none bg-white px-5 text-base text-[#1f1c2e] outline-none placeholder:text-[#1f1c2e] placeholder:opacity-60 dark:bg-[#1f2937] dark:text-white dark:placeholder:text-[#ffffffcc]"
              type="text"
              placeholder="Search"
            />
            <svg
