    ...
    <article className="rw-segment overflow-x-auto">
      <header className="rw-segment-header">
        ...
        <FormControl variant="outlined">
          ...
          <Input defaultValue={'test'} startAdornment={
            <svg
              aria-hidden="true"
        ...
        <FormControl variant="filled" color="warning" size="medium">
          <InputLabel>
            testabc
          </InputLabel>
          <Input defaultValue={'test'} startAdornment={
        ...
        <FormControl size="medium" variant="standard" color="warning" error>
          <InputLabel>
            test1233
          </InputLabel>
        ...
        <TextInput variant="outlined" id="test12345" size="small" color="success" label="test" helperText="test" InputProps={{
          endAdornment: (
            <svg
              aria-hidden="true"
              className="h-4 w-4 inline-block"
        ...
        <Lookup options={["test"]} size="small" />
      </header>
