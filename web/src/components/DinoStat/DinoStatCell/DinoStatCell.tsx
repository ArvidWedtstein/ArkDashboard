import type { FindDinoStatById } from 'types/graphql'

import type { CellSuccessProps, CellFailureProps } from '@redwoodjs/web'

import DinoStat from 'src/components/DinoStat/DinoStat'

export const QUERY = gql`
  query FindDinoStatById($id: String!) {
...
export const Empty = () => <div>DinoStat not found</div>
...
export const Success = ({ dinoStat }: CellSuccessProps<FindDinoStatById>) => {
  return <DinoStat dinoStat={dinoStat} />
}
