import type { FindDinoStats } from 'types/graphql'

import { Link, routes } from '@redwoodjs/router'
import type { CellSuccessProps, CellFailureProps } from '@redwoodjs/web'

import DinoStats from 'src/components/DinoStat/DinoStats'
...
export const Empty = () => {
  return (
    <div className="text-center text-black dark:text-white">
      {'No dinoStats yet. '}
      <Link to={routes.newDinoStat()} className="rw-link">
        {'Create one?'}
      </Link>
    </div>
  )
...
export const Success = ({ dinoStats }: CellSuccessProps<FindDinoStats>) => {
  return <DinoStats dinoStats={dinoStats} />
}
