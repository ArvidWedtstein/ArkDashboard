...
const Icon = (icon: string) => {
  ...
  const icons = {
    ...
    basespot: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-4 w-4 fill-current stroke-current">
    ...
    crafting: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-4 w-4 fill-current stroke-current">
    ...
    gtw: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="h-4 w-4 fill-current stroke-current">
