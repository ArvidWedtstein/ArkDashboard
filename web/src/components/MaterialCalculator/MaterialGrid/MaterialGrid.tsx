        ...
        <Form onSubmit={onAdd} error={error}>
          ...
          <div className="relative flex flex-row space-x-3">
            ...
            <div className="inline-flex rounded-md shadow-sm" role="group">
              ...
              <button type="button" onClick={clear} className="first:rounded-l-lg last:rounded-r-lg rounded-none inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-red-500 transition-colors dark:focus:ring-blue-500 dark:focus:text-white">
