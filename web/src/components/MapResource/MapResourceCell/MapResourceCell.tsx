import type { FindMapResourceById } from 'types/graphql'

import type { CellSuccessProps, CellFailureProps } from '@redwoodjs/web'

import MapResource from 'src/components/MapResource/MapResource'

export const QUERY = gql`
  query FindMapResourceById($id: BigInt!) {
...
export const Empty = () => <div>MapResource not found</div>
...
export const Success = ({
  mapResource,
}: CellSuccessProps<FindMapResourceById>) => {
  return <MapResource mapResource={mapResource} />
}
