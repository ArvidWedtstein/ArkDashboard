const StatCard = ({ stat, value }: { stat: string, value: number | string}) => {
  return (
    <div>
      <div className="p-2">
        <div className="rounded p-4 w-100 flex items-center bg-stone-200 dark:bg-gray-800">
          <div className="shrink-0 basis-28">
            <h2 className="mb-2 text-xs uppercase font-semibold text-slate-600">{stat}</h2>
