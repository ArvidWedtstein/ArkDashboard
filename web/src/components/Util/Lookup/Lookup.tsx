...
//   const [openIndexes, setOpenIndexes] = useState([]);
//   const [lookupitems, setItems] = useState<
//     { name?: string; image?: string; value?: string | number }[]
//   >([]);
...
//       const defVal = items.find(
//         (f) => f.value == defaultValue || f == defaultValue
//       );
//       console.log(defVal)
//       console.log(items.find(
//         (f) => f.value == parseInt(defaultValue)
//       ))
...
//             {...register}
//             id={name}
//             value={inputValue ? (inputValue["name"] || inputValue || inputValue["value"]) : defaultValue}
//             className="flex w-full items-center bg-transparent outline-none"
//             onChange={(e) => inputValue ? handleInputChange(e) : {}}
//             placeholder={'Search...'}
//             disabled={disabled}
//           />
//         ) : (
...
//               name={name}
//               id={name}
//               value={inputValue["value"] || inputValue || inputValue["name"]}
//               className="hidden"
//               onChange={handleInputChange}
//               disabled={disabled}
//               {...register}
