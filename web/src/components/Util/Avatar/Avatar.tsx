    ...
    return (
      ...
      >
        <ClickAwayListener onClickAway={() => setOpenProfile(false)}>
          <div
            className={clsx(
              `border-secondary-600 relative flex aspect-square w-full items-center justify-center overflow-hidden rounded-full border bg-zinc-300 transition-colors dark:bg-zinc-900`,
              className,
              {
