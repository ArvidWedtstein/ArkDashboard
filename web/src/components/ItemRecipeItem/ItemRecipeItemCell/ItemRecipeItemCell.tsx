import type { FindItemRecipeItemById } from 'types/graphql'

import type { CellSuccessProps, CellFailureProps } from '@redwoodjs/web'

import ItemRecipeItem from 'src/components/ItemRecipeItem/ItemRecipeItem'

export const QUERY = gql`
  query FindItemRecipeItemById($id: String!) {
...
export const Empty = () => <div>ItemRecipeItem not found</div>
...
export const Success = ({
  itemRecipeItem,
}: CellSuccessProps<FindItemRecipeItemById>) => {
  return <ItemRecipeItem itemRecipeItem={itemRecipeItem} />
}
