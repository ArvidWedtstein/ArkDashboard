...
import type { CreateItemRecipeItemInput, NewItemRecipeItem } from 'types/graphql'

export const QUERY = gql`
  query NewItemRecipeItem {
    items {
      id
      name
    }
...
export const Success = ({
  items,
}: CellSuccessProps<NewItemRecipeItem>) => {
  ...
  return (
    <div className="rw-segment">
      ...
      <div className="rw-segment-main">
        <ItemRecipeItemForm onSave={onSave} items={items} loading={loading} error={error} />
      </div>
    </div>
  )
};
