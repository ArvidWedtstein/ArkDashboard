...
const ItemsList = ({ itemsPage, loading = false }: FindItems & {
  ...
  useEffect(() => {
    switch (category) {
      case "structure":
        setTypes(["Tek", "Building", "Crafting", "Electrical", "Vehicle", "Elevator", "Adobe", "Utility", "Greenhouse", "Metal", "Wood", "Thatch", "Stone"])
        break;
      case "armor":
        ...
        <nav className="flex flex-row space-x-2 justify-center">
          ...
          <div className="rw-button-group">
            ...
            <input
              ...
              name="view"
              value="grid"
              className="peer/grid hidden bg-no-"
              checked={view === "grid"}
